...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_CHIPSHOVER /* BOARD_ARCHIM2 */
#endif
...
//#define ENDSTOP_INTERRUPTS_FEATURE /* CHANGED TODO */
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1600*4, 1600*4, 1600*4, 500 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 60, 60, 60, 60 }
...
#define X_HOME_DIR -1
#define Y_HOME_DIR -1
#define Z_HOME_DIR 1 /*NB - Need to home to 'max' to force Z-axis homing to happen first, and we reverse axis direction and swap min/max endstops. Big old hacks. */
...
#define HOMING_FEEDRATE_MM_M { (150), (150), (150) }
